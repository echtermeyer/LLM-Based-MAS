...
tasks tested (Section~\ref{sec:results:evid}).
...
into existence.
In the language of \autoref{sec:bg:complex}, this is self-organization with its
second ingredient missing: positive feedback and fluctuations are both present,
but the negative feedback that would bound an early lead, Camazine's stabilising
ingredient (ii), is absent, so the group amplifies its opening distribution
