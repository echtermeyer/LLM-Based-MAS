...
with simpler alternatives \citep{liu2025stopovervaluing, zhang2025debateorvote,
bertalanic2026costofconsensus}; multi-agent LLM systems more broadly exhibit
failure rates between 41\% and 86.7\% across seven frameworks
\citep{cemri2025mast}. More
...
debate into a mutually agreeing echo chamber.
...
\emph{multistability}, the coexistence of multiple stable outcomes selected by
...
conventions on the majority. \citet{okawa2026biasedconsensus} derives a formal model predicting that once
conformity pressure among agents exceeds a critical threshold, even small
individual biases are amplified into a shared collective bias.
What these convention-based treatments share is a substrate in which no option is better than any
other, so they can show that a group locks in but not whether it locks in on the
right answer; the epistemic case, where some claims are better supported than
others, remains open.
...
that identify self-reinforcement, limit cycles, multistability, and dominance in
...
Instruments are beginning to appear from other directions: learned classifiers that predict from interpretable
...
\begin{itemize}
  \item[\textbf{RQ1}] \textbf{Measurement.} Can self-organization motifs,
        specifically self-reinforcement, limit cycles, multistability, and
...
\begin{itemize}
  \item \textbf{An instrument for measuring debate dynamics.} We define a
        ...
        multistability, dominance, and limit cycles, each grounded in the
  ...
  \item \textbf{An empirical characterisation at scale.} We apply \suitename{}
        ...
        convergence, multistability is common and is a stable property of the task
