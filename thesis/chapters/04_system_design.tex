...
\centering
\small
\caption{Notation used throughout this thesis. Rounds are indexed by $t$ and
...
\end{tikzpicture}
\caption{Two-phase synchronous protocol for two agents over rounds
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/time_savings.png}
    \caption{Mean fraction of runtime saved by early stopping as a function of
...
\bottomrule
\end{tabular}
\caption{Classification of tunable components. Full justification per knob is
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/task_difficulty_4tiers.png}
    \caption{Distribution of tasks across difficulty tiers for GPQA-Diamond and
...
configurations each, $R = 30$ repetitions}, for a total of
$35 \times 2 \times 6 \times 30 = 12{,}600$ repetitions. Because $R = 3$ in the
