...
Table~\ref{tab:app:perf:configs} reports accuracy, mean rounds to consensus,
...
\bottomrule
\end{tabular}
\caption{Full system performance per configuration
...
\begin{figure}[H]
  ...
  \caption{Mean accuracy as a function of rounds to consensus,
...
Section~\ref{sec:results:highrep} ($R = 1{,}000$, three GPQA tasks,
$W = 2$, fully-connected topology, $N = 4$ agents).

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{plots/highrep/figA_full_feature_breakdown.png}
  \caption{Full breakdown of accuracy (top row) and efficiency (bottom row, where
...
\begin{figure}[H]
  ...
  \caption{Feature-outcome correlation matrix for the high-repetition experiment.
...
\begin{figure}[H]
  ...
  \caption{Feature distributions split by outcome (correct: colour; incorrect: grey)
           ...
           (see Section~\ref{sec:results:highrep}).}
