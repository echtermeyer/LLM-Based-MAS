...
\subsection{Bistability: Supplementary Figures}
\label{app:bistab}

\paragraph{Bistability: configuration effects (supplementary figures).}
...
public/private dissociation; the \arguephase{} \texttt{question} field yields the
